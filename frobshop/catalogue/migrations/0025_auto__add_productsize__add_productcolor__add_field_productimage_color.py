...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalogue_productcolor', (
            ...
            ('color_thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'catalogue', ['ProductColor'])

        # Adding field 'ProductImage.color'
        db.add_column(u'catalogue_productimage', 'color',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_image_color', null=True, to=orm['catalogue.ProductColor']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductImage.color'
        db.delete_column(u'catalogue_productimage', 'color_id')
    ...
    models = {
        ...
        u'catalogue.product': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'designer': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'catalogue.productcolor': {
            'Meta': {'object_name': 'ProductColor'},
            'color': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'color_thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'catalogue.productimage': {
            ...
            'color': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'product_image_color'", 'null': 'True', 'to': u"orm['catalogue.ProductColor']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
