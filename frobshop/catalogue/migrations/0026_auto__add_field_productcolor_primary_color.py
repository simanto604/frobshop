...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductColor.primary_color'
        db.add_column(u'catalogue_productcolor', 'primary_color',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductColor.primary_color'
        db.delete_column(u'catalogue_productcolor', 'primary_color')
