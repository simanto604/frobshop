...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductColor.product'
        db.add_column(u'catalogue_productcolor', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='product_color', null=True, to=orm['catalogue.Product']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductColor.product'
        db.delete_column(u'catalogue_productcolor', 'product_id')
