...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductImage.shopbop_image_url'
        db.add_column(u'catalogue_productimage', 'shopbop_image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductImage.shopbop_image_url'
        db.delete_column(u'catalogue_productimage', 'shopbop_image_url')
